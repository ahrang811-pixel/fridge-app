      ...
      <div className="mx-auto flex w-full max-w-2xl flex-col gap-8">
        ...
        <div className="flex flex-col gap-6 rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
          ...
          <Section title="3. 외부 서비스로의 정보 전송 (제3자 제공·처리위탁)">
            ...
            <ul className="list-disc pl-5">
              ...
              <li>
                ...
                영상 제목·설명란·댓글 텍스트가 레시피 정보 분석을 위해
          ...
          <Section title="4. 광고 및 제휴 링크 안내">
            <p>
              서비스는 현재 광고나 제휴 링크를 사용하지 않지만, 향후 쿠팡
              파트너스 등 제휴 마케팅 링크나 광고를 추가할 수 있습니다. 이
              경우 레시피의 재료를 구매 링크와 연결하는 등의 형태가 될 수
              있으며, 추가 시 이 방침을 갱신해 안내합니다. 제휴 링크를 통한
              구매가 발생해도 이용자가 추가로 부담하는 비용은 없습니다.
            </p>
          </Section>
